...
class signup:
    def __init__(self,root):
        ...
        #bg image
        self.img=PhotoImage(file="IMG_20200720_144928.png")
        ...
        login_button=Button(self.root,text="Login",bg="lightgreen",fg="red",activebackground="lightgreen",activeforeground="red",font="Helvetica 15 bold",width=14,cursor="hand2",command=self.login_func)
        login_button.place(x=390,y=350)
        #clock
